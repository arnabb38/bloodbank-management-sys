package com.arnabb.bbms.Search;// update info

import com.arnabb.bbms.Donor.DonorLogin;
						...
						if(mobTF.getText().length()!=0 && mobTF.getText().length()==11 ) {
							...
							if(mailTF.getText().length()!=0 && mailTF.getText().matches("(.*)@(.*).com(.*)") == true ) {  
								...
								if(passTF.getText().length()>=5) {
									...
									JOptionPane.showMessageDialog(null, "com.arnabb.bbms.Search.Update Succeed!");
