...
public class AdminPanel extends JFrame implements ActionListener
{
	...
	public AdminPanel(String adId) 
	{
		...
		deleteDonorButton = new JButton("Delete Donor Acc");
	...
	public void actionPerformed(ActionEvent ae)
	{
		...
		else if(buttonClicked.equals(RegDonorButton.getText()))
		{
			...
			this.add(Register.getRegRef().panel,BorderLayout.CENTER);
			System.out.println("again hell");
			this.remove(this.panel);
			//Register.getRegRef().paintALL(Register.getRegRef().getGraphics());*/
